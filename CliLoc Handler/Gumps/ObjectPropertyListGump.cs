...
namespace Server.Gumps
{
    ...
    public class ObjectPropertyListGump : Gump
    {
        ...
        {
            if (player.HasGump<ObjectPropertyListGump>())
            {
                ObjectPropertyListGump gump = player.FindGump<ObjectPropertyListGump>();
        ...
        public ObjectPropertyListGump(Mobile owner,Object o) : base(10,10)
        {
            ...
            _Owner.CloseGump<ObjectPropertyListGump>();
        ...
        protected void DeterminePageLayout()
        {
            if (_Object == null)
            {
                // Log or handle the null object case
                _Width = 100;
                _Height = 100;
                return;
            }
            ...
            if (_PropsList == null)
            {
                // Log or handle the null properties list case
                _Width = 100;
                _Height = 100;
                return;
            }
