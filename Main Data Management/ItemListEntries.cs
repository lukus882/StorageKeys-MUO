...
namespace Solaris.ItemStore
{
    ...
    public class ItemListEntry : IComparable
    {
        ...
        public ItemListEntry(IGenericReader reader)
        {
            Deserialize(reader);
        }
        ...
        public virtual void Deserialize(IGenericReader reader)
        {
            ...
            switch (version)
            {
                ...
                default:
                    {
                        _Type = AssemblyHandler.FindTypeByName(reader.ReadString());
    ...
    public class TreasureMapListEntry : ItemListEntry
    {
        ...
        //world load constructor
        public TreasureMapListEntry(IGenericReader reader) : base(reader)
        {
        }
        ...
        public override void Deserialize(IGenericReader reader)
        {
            ...
            _Decoder = reader.ReadEntity<Mobile>();
    ...
    public class SOSListEntry : ItemListEntry
    {
        ...
        //world load constructor
        public SOSListEntry(IGenericReader reader) : base(reader)
        {
        }
    ...
    public class SpecialFishingNetListEntry : ItemListEntry
    {
        ...
        //world load constructor
        public SpecialFishingNetListEntry(IGenericReader reader) : base(reader)
        {
        }
    ...
    public class InstrumentListEntry : ItemListEntry
    {
        ...
        public override List<ItemListEntryColumn> Columns
        {
            get
            {
                if (_Columns == null)
                {
                    ...
                    _Columns.Add(new ItemListEntryColumn(600,"Crafter",_CrafterName ?? "-none-"));
        ...
        public string CrafterName { get { return _CrafterName; } }
        ...
        public InstrumentListEntry(Item item) : base(item)
        {
            ...
            _CrafterName = instrument.Crafter;
        }

        //world load constructor
        public InstrumentListEntry(IGenericReader reader) : base(reader)
        {
        }
        ...
        public InstrumentListEntry(InstrumentListEntry entry) : base(entry)
        {
            ...
            _CrafterName = entry.CrafterName;
        }
        ...
        public override Item GenerateItem()
        {
            ...
            instrument.Crafter = _CrafterName;
        ...
        public override void Deserialize(IGenericReader reader)
        {
            ...
            _CrafterName = reader.ReadString();
        }
    }
    ...
    public class SeedListEntry : ItemListEntry
    {
        ...
        //world load constructor
        public SeedListEntry(IGenericReader reader) : base(reader)
        {
        }
    ...
    public class RepairDeedListEntry : ItemListEntry
    {
        ...
        public override List<ItemListEntryColumn> Columns
        {
            get
            {
                if (_Columns == null)
                {
                    ...
                    _Columns.Add(new ItemListEntryColumn(250,"Crafter",_CrafterName ?? "-null-"));
        ...
        public RepairDeedListEntry(Item item) : base(item)
        {
            ...
            _Name = deed.Skill.ToString();
            _RepairSkillType = deed.Skill;
            _Level = deed.SkillLevel;
            _CrafterName = deed.Crafter;
        }

        //world load constructor
        public RepairDeedListEntry(IGenericReader reader) : base(reader)
        {
        }
        ...
        {
            //awesome constructor!
            RepairDeed deed = new RepairDeed(_RepairSkillType, _Level, _Insured); // Pass _Insured directly

            deed.LootType = _LootType;
            // deed.Insured = _Insured; // This line is redundant since you're already setting it in the constructor
    ...
    public class BaseAddonDeedListEntry : ItemListEntry
    {
        ...
        //world load constructor
        public BaseAddonDeedListEntry(IGenericReader reader) : base(reader)
        {
        }
    ...
    public class PowerScrollListEntry : ItemListEntry
    {
        ...
        //world load constructor
        public PowerScrollListEntry(IGenericReader reader) : base(reader)
        {
        }
    ...
    public class StatCapScrollListEntry : ItemListEntry
    {
        ...
        //world load constructor
        public StatCapScrollListEntry(IGenericReader reader) : base(reader)
        {
        }
