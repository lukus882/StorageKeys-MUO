...
namespace Solaris.ItemStore
{
    ...
    public class ListEntry : StoreEntry
    {
        ...
        public ListEntry(IGenericReader reader) : base(reader)
        {
        }
        ...
        public override void Deserialize(IGenericReader reader)
        {
            ...
            switch (version)
            {
                ...
                default:
                    {
                        _ItemListEntryType = AssemblyHandler.FindTypeByName(reader.ReadString());
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            Type type = AssemblyHandler.FindTypeByName(typestring);
