...
namespace Solaris.ItemStore
{
    ...
    public class StoreEntry
    {
        ...
        public StoreEntry(IGenericReader reader)
        {
            Deserialize(reader);
        }
    ...
    public class ColumnSeparationEntry : StoreEntry
    {
        ...
        public ColumnSeparationEntry(IGenericReader reader) : base(reader)
        {
        }
    ...
    public class ResourceEntry : StoreEntry
    {
        ...
        //generic reader deser constructor
        public ResourceEntry(IGenericReader reader) : base(reader)
        {
        }
    ...
    public class ToolEntry : StoreEntry
    {
        ...
        //generic reader deser constructor
        public ToolEntry(IGenericReader reader) : base(reader)
        {
        }
    ...
    public class GenericEntry : StoreEntry
    {
        ...
        //generic reader deser constructor
        public GenericEntry(IGenericReader reader) : base(reader)
        {
        }
    ...
    public class GenericDistinguishableEntry : StoreEntry
    {
        ...
        //generic reader deser constructor
        public GenericDistinguishableEntry(IGenericReader reader) : base(reader)
        {
        }
        ...
        public override Item Withdraw(ref int amount, bool makedeed)
        {
            ...
            // Use reflection to convert string to enum/type
            object toset = null;
            try
            {
                if (pi.PropertyType.IsEnum)
                {
                    toset = Enum.Parse(pi.PropertyType, DistinguishValue);
                }
                else
                {
                    toset = Convert.ChangeType(DistinguishValue, pi.PropertyType);
                }
            }
            catch
            {
    ...
    public class RunicToolEntry : StoreEntry
    {
        ...
        //generic reader deser constructor
        public RunicToolEntry(IGenericReader reader) : base(reader)
        {
        }
    ...
    public class ChampionSkullEntry : StoreEntry
    {
        ...
        //generic reader deser constructor
        public ChampionSkullEntry(IGenericReader reader) : base(reader)
        {
        }
    ...
    public class AncientSmithyHammerToolEntry : StoreEntry
    {
        ...
        //generic reader deser constructor
        public AncientSmithyHammerToolEntry(IGenericReader reader) : base(reader)
        {
        }
    ...
    public class PotionEntry : StoreEntry
    {
        ...
        //generic reader deser constructor
        public PotionEntry(IGenericReader reader) : base(reader)
        {
        }
        ...
        public override Item FindRecipient(Mobile from)
        {
            ...
            foreach (var item in from.Backpack.FindItemsByType(typeof(PotionKeg)))
            {
                if (item is PotionKeg recipient && (recipient.Held == 0 || (recipient.Type == _Effect && recipient.Held < 100)))
                {
                    return recipient;
                }
            }

            foreach (var item in from.Backpack.FindItemsByType(typeof(Bottle)))
            {
                return item;
            }
    ...
    public class BeverageEntry : StoreEntry
    {
        ...
        //generic reader deser constructor
        public BeverageEntry(IGenericReader reader) : base(reader)
        {
        }
        ...
        public override Item FindRecipient(Mobile from)
        {
            ...
            foreach (var item in from.Backpack.FindItemsByType(typeof(BaseBeverage)))
            {
                if (item is BaseBeverage recipient && (recipient.Quantity == 0 || (recipient.Content == _BeverageType && !recipient.IsFull && recipient.Poison == null)))
                {
                    return recipient;
                }
            }
    ...
    public class InstrumentEntry : StoreEntry
    {
        ...
        //generic reader deser constructor
        public InstrumentEntry(IGenericReader reader) : base(reader)
        {
        }
