...
namespace Solaris.ItemStore
{
    ...
    public class SmallBODListEntry : ItemListEntry
    {
        ...
        public SmallBODListEntry(IGenericReader reader) : base(reader)
        {
        }
        ...
        public override void Deserialize(IGenericReader reader)
        {
            ...
            _BODFillType = AssemblyHandler.FindTypeByName(reader.ReadString());
	...
	*/
	...
	public class LargeBODMobileListEntry : ItemListEntry
	{
		...
		public override void Deserialize(GenericReader reader)
		{
			...
			{
				_Entries[i] = new LargeMobileBulkEntry(reader, null);
			}
    ...
    public class LargeBODListEntry : ItemListEntry
    {
        ...
        //world load constructor
        public LargeBODListEntry(IGenericReader reader) : base(reader)
        {
        }
        ...
        public override void Deserialize(IGenericReader reader)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                _Entries[i] = new LargeBulkEntry(reader, null);
            }
